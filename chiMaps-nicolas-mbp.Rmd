...
MyHexBin2 <- function(x, extent = NA, cellsize = 100, mrg = 100) {
  ...
  quarter = cellsize/4
    ...
    for (i in c(c(0,0,0,0), 
                c(0,0,-half,-half), 
                c(half,half,quarter,quarter), 
                c(-half,-half,quarter,quarter))) {
...
countMap = function(hexBinFunction, data, cellsize = 100, title, datapoints, pointopacity = 1, mode = "view") {
  ...
  hexData = hexBinFunction(data, st_bbox(accidents), cellsize = cellsize, mrg = 100) %>%
  filter(!ïAccUID == 0)
...
BicChiMap <- chiMap(hexBinFunction = MyHexBin, reference = accidents, focus = bycicle, cellsize = 100, title = "Bicycle Accidents Chi Map", datapoints = bycicle, mode = "view") 

MotChiMap <- chiMap(hexBinFunction = MyHexBin, reference = accidents, focus = motorCycle, cellsize = 100, title = "Motorcycle Accidents Chi Map", datapoints = motorCycle, mode = "view") 

PedChiMap <- chiMap(hexBinFunction = MyHexBin, reference = accidents, focus = pedestrians, cellsize = 100, title = "Pedestrians Accidents Chi Map", datapoints = pedestrians, mode = "view") 
...
SevereChiMap <- chiMap(hexBinFunction = MyHexBin, reference = accidents, focus = severe, cellsize = 100, title = "Severe Accidents Chi Map", datapoints = severe, mode = "view") 
